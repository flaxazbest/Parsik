...
public class Videocard implements Serializable {
    ...
    public Videocard(String fullName, String manufacture, int price, HashMap<String, String> detail) {
    ...
    public Videocard(String fullName, String manufacture, int price) {
        this.fullName = fullName;
        this.manufacture = manufacture;
        this.price = price;
    }
